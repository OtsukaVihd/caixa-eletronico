...
class BankAccount:
    ...
    def __init__(self, account_number, password, name, value, admin):
...
class CashMachine:
    ...
    def __calculate_money_slips_user(self, money_bill):
        ...
        if self.value_remaining // money_bill_int > 0 and  self.value_remaining // money_bill_int <= self.money_slips[money_bill]:
            self.money_slips_user[money_bill] = self.value_remaining//money_bill_int
            self.value_remaining -= self.value_remaining//money_bill_int*money_bill_int
...
accounts_list = [
    BankAccount('0001-02', '123456', 'Fulano da Silva',  100, False),
    BankAccount('0002-02', '654321', 'Ciclano da Silva', 50, False),
    BankAccount('1111-11', '111111', 'Admin da Silva', 1000, True)
]